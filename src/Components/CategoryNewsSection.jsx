                  ...
                  <button
                    onClick={() => {
                      ...
                      if (navigator.share) {
                        ...
                        alert('लिंक कॉपी हो गया! अब आप कहीं भी शेयर कर सकते हैं।');
                      }
                    }}
                    className="flex items-center gap-2 text-white bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 px-4 py-2 rounded-full font-semibold shadow hover:scale-105 transition-all duration-200 mb-2 mt-1"
                    title="शेयर करें"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 12v2a4 4 0 004 4h8a4 4 0 004-4v-2" /><path strokeLinecap="round" strokeLinejoin="round" d="M16 6l-4-4-4 4M12 2v14" /></svg>
                    शेयर
                  </button>
                </div>
