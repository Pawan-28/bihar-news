...
import { testMetaTags, makeImageUrlAbsolute } from "../../utils/testMetaTags";
      ...
      try {
        ...
        if (found) {
          ...
          const cleanedArticle = {
            ...
            image: found.image || found.imageUrl || '/default-article.jpg'
          };

          setArticle(cleanedArticle);
          setLikeCount(cleanedArticle.likes);
          
          // Test meta tags for debugging
          testMetaTags(cleanedArticle);
          ...
          const related = allArticles
            ...
            .map(a => ({
              ...
              image: makeImageUrlAbsolute(a.image || a.imageUrl || '/default-article.jpg'),
  ...
  return (
    <>
      {article && (
        <Helmet>
          {/* Basic Meta Tags */}
          <title>{article.title} - हर्षित के कलम से</title>
          ...
          <meta property="og:image" content={makeImageUrlAbsolute(article.image)} />
          <meta property="og:image:width" content="1200" />
          <meta property="og:image:height" content="630" />
          <meta property="og:image:type" content="image/jpeg" />
          <meta property="og:url" content={`https://harshit-ka-kalam-se.netlify.app/article/${article.id}`} />
          ...
          <meta name="twitter:image" content={makeImageUrlAbsolute(article.image)} />
          <meta name="twitter:site" content="@harshitkakalam" />
          
          {/* Additional Meta Tags */}
          <meta name="author" content="हर्षित के कलम से" />
          <meta name="robots" content="index, follow" />
          <link rel="canonical" href={`https://harshit-ka-kalam-se.netlify.app/article/${article.id}`} />
          
          {/* WhatsApp specific meta tags */}
          <meta property="og:image:secure_url" content={makeImageUrlAbsolute(article.image)} />
