  ...
  const fetchContent = async () => {
    try {
      ...
      const endpoint = contentType === 'news' 
        ? `https://harshit-backend.onrender.com/api/news/${id}`
        : `https://harshit-backend.onrender.com/api/content/${contentType}/${id}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        ...
        // Create new content
        const endpoint = contentType === 'news'
          ? 'https://harshit-backend.onrender.com/api/news'
          : `https://harshit-backend.onrender.com/api/content/${contentType}`;
